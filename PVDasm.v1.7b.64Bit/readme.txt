...
-> 27.03.2011:	* Fixed a nasty bud in the PE Import scanner which caused PVDasm to crash.
		* Known Issues:
...
-> 03.02.2003:  * Added a pe rebuilder
		...
		* Added a partial process dumper
		  ...
		  notes: full/partial dump does not work under
			...
			??????????????????????????????????????????????????????????????????????
               	 	?                                                                    ?
			? PVDasm.exe (32Bit) MD5 hash    : e9e321f11004fbb5901aed1b26a88c5b  ?
			? PVDasm.exe (64Bit) MD5 hash    : 47cf654bcb6b01e991e8526d7a0fd2c0  ?
                	?                                                                    ?
